    ...
    <div className={css({ minH: "100vh", bg: "#f4f4f4" })}>
      <div className="sber-container">
        <header className={stack({ gap: "4px", mb: "32px" })}>
          <h1 className={css({ fontSize: "24px", fontWeight: "800", color: "#000" })}>Статистика</h1>
        </header>
        ...
        <section className={stack({ align: "center", py: "60px", gap: "20px" })}>
          ...
          <div className={stack({ gap: "8px", textAlign: "center" })}>
            <h2 className={css({ fontSize: "18px", fontWeight: "700", color: "#000" })}>Скоро здесь будет график</h2>
          ...
          <div className={flex({ align: "center", gap: "8px", px: "16px", py: "8px", bg: "#f1f5f9", borderRadius: "12px", color: "#64748b" })}>
            <Clock size={14} />
