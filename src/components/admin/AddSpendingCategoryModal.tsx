...
import { createSpendingCategory } from "@/lib/actions/spending-categories";
import SearchableSelect from "@/components/SearchableSelect";

interface AddSpendingCategoryModalProps {
  parentOptions: { value: string; label: string }[];
}

export default function AddSpendingCategoryModal({ parentOptions }: AddSpendingCategoryModalProps) {
  ...
  return (
    <>
      ...
      >
        <Plus size={16} strokeWidth={3} /> Добавить категорию
      </button>
